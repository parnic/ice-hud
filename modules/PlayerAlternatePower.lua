...
function PlayerAlternatePower.prototype:Update(unit)
	...
	if not IceHUD.IceCore:ShouldUseDogTags() then
		self:SetBottomText1(string.format("%.0f", UnitPowerPercent and UnitPowerPercent(self.unit, self.powerIndex, true, CurveConstants.ScaleTo100) or math.floor(self.powerPercent * 100)))
